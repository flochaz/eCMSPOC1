        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('ecmspoc1App.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-ecmspoc1App-error');
                                var entityKey = httpResponse.headers('X-ecmspoc1App-params');
                                if (errorHeader) {
